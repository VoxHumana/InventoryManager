...
namespace InventoryManager.ViewModels
{
    ...
    public class InventoryViewModel: PropertyChangedBase, IHandle<ProductInventoryEntry>
    {
        ...
        private readonly XmlSerializer _xmlSerializer = new XmlSerializer(typeof(ObservableCollection<ProductInventoryEntry>));
        ...
        {
            ProductInventoryEntry entry1 = new ProductInventoryEntry(5, "Belt", 10, 3);
            ProductInventoryEntry entry2 = new ProductInventoryEntry(10, "Vase", 15, 5);
            ProductInventoryEntry entry3 = new ProductInventoryEntry(15, "Painting", 12, 5);
